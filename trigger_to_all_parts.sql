...
AFTER INSERT ON if0_35925202_mydb.wp_metforms
FOR EACH ROW
BEGIN
    INSERT INTO if0_35925202_mydb.wp_ebss_part_1 (ID, user_email, full_name, first_name, last_name, staff_ID, clientName, company_email, job_title, gender, work_location, department, work_section, year_service)
...
FOR EACH ROW
BEGIN
    INSERT INTO if0_35925202_mydb.wp_ebss_part_2_1 (ID, laptop, standardPC, external, dockingNE, dockingE, standardMW, standardMNW, ErgomouseNW, ErgomouseW, shortkey, longkey, riserA, riserNA, BagA, BagB, BagC, mousepadA, mousepadB, wristpadA, wristpadB)
...
FOR EACH ROW
BEGIN
    INSERT INTO if0_35925202_mydb.wp_ebss_part_2_2 (ID, laptop2, standardPC2, external2, dockingNE2, dockingE2, standardMW2, standardMNW2, ErgomouseNW2, ErgomouseW2, shortkey2, longkey2, riserA2, riserNA2, BagA2, BagB2, BagC2, mousepadA2, mousepadB2, wristpadA2, wristpadB2)
...
FOR EACH ROW
BEGIN
    INSERT INTO if0_35925202_mydb.wp_ebss_part_3 (ID, headMid, headRight, headLeft, neckMid, neckRight, neckLeft, UpshoulderRight, UpshoulderLeft, shoulderJointRight, shoulderJointLeft, elbowRight, elbowLeft, upperFright, upperFlight, upperWristRight, upperWristLeft, lowerWristRight, lowerWristLeft, fingersRight, fingersLeft, LowerBackMid, LowerBackRight, LowerBackLeft, torsoMid, torsoRight, torsoLeft, hipJointRight, hipJointLeft, kneeRight, kneeLeft, calvesRight, calvesLeft, ankleRight, ankleLeft, HeelsRight, HeelsLeft)
